...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'user_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\mgcms\db\User::find()->orderBy('username')->asArray()->all(), 'id', 'username'),
        ...
        'is_preico' => ['type' => TabularForm::INPUT_CHECKBOX,
            'options' => [
                'style' => 'position : relative; margin-top : -9px'
            ]
        ],
        'user_token' => ['type' => TabularForm::INPUT_TEXT],
        'del' => [
            'type' => 'raw',
            'label' => '',
