...
use app\models\mgcms\db\FaqItemSearch;
...
/**
 * FaqItemController implements the CRUD actions for FaqItem model.
 */
class FaqItemController extends MgCmsController
{
    ...
    /**
     * 
     * Export FaqItem information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new FaqItem model by another data,
